...
N.B. : codes in iqa folder are adopted from https://github.com/chaofengc/IQA-PyTorch/tree/main/pyiqa and that of torch_utils and dnnlib are taken from https://github.com/NVlabs/stylegan2-ada-pytorch
